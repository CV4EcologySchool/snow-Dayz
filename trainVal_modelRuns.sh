...
python classifier/train.py --config configs/exp_resnet50_2classes.yaml --exp_dir experiments --exp_name exp_resnet50_2classes_seq6hr  --train_folder train_resized --val_folder val_resized

python classifier/train.py --config configs/exp_resnet50_2classes.yaml --exp_dir experiments --exp_name exp_resnet50_2classes_seq12hr --train_folder train_resized --val_folder val_resized

python classifier/train.py --config configs/exp_resnet50_2classes.yaml --exp_dir experiments --exp_name exp_resnet50_2classes_seq24hr --train_folder train_resized --val_folder val_resized
