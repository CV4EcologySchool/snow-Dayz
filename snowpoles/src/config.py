...
OUTPUT_PATH = '/Users/catherinebreen/Documents/Chapter 1/dendrite_outputs/IN/snow_poles_outputs_resized_LRe4_BS64_clean_wWAOK_IN'

# learning parameters
BATCH_SIZE = 64 #64 #4 #32
LR = 0.00001  # #0.0001 lower to factor of 10
EPOCHS = 100 #100
DEVICE = torch.device('mps') # if torch.cuda.is_available() else 'cpu')  #should be cuda on VMs
# train/test split
